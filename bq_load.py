...
with DAG(
    ...
    dag.doc_md = """
    # Workshop5: ใช้คำสั่ง bq load ใน BashOperator """
    ...
    # BashOperator เพื่อโหลดไฟล์ output.csv ไปเก็บใน BigQuery 
    t4 = BashOperator(
        task_id="load_to_bigquery",
        Bash_command="bq_load \
            --source_format=csv --autodetect \
            workshop5.audible_data \
            gs://asia-southeast1-storagebook-0feb77be-bucket/data/output.csv",
    )
